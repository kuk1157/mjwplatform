package com.pudding.base.crypto.util;
...
public class CryptoEnvelopeUtil {
     ...
     */
    public static void write(Path out, byte[] ciphertext, EnvelopeMeta meta) throws IOException {
    ...
    public record ReadResult(byte[] ciphertext, EnvelopeMeta meta) {
    }
}
