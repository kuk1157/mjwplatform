...
public class FileCrypto {
    ...
    public static class EncryptOutput {
        ...
        private final EncryptedMeta meta;
    }
    ...
    public EncryptOutput encryptBytes(byte[] plaintext, String aad) throws Exception {
        try (var in = new ByteArrayInputStream(plaintext);
            ...
            var meta = EncryptedMeta.builder()
                    .ivB64(res.ivB64)
     ...
     */
    public byte[] decryptBytes(byte[] ciphertext, EncryptedMeta meta) throws Exception {
     ...
     */
    public EncryptedMeta encryptTo(OutputStream cipherOut, InputStream plainIn, String aad) throws Exception {
     ...
     */
    public void decryptTo(OutputStream plainOut, InputStream cipherIn, EncryptedMeta meta) throws Exception {
     ...
     */
    public boolean rewrapIfNeeded(EncryptedMeta meta) throws Exception {
