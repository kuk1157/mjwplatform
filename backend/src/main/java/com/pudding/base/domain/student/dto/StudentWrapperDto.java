...
public class StudentWrapperDto {
    ...
    @Builder
    public StudentWrapperDto(Integer id, Integer creatorId, Student student, String school, Integer age, String teacherName, IsActive hasAssist, Integer assistCount,
    ...
    public static StudentWrapperDto fromEntity(StudentDetail studentDetail) {
        return StudentWrapperDto.builder()
                .id(studentDetail.getId())
                .student(studentDetail.getStudent())
    ...
    public StudentDetail toEntity(StudentDetail studentDetail) {
