...
const Footer = () => {
    ...
    return (
        <footer className="w-full font-Pretendard tracking-[-0.34px] leading-[19px] ">
            <div className="px-[100px] pt-[80px] pb-[60px] lg:px-20 lg:py-24 md:pt-10 md:pb-12 md:py-10 sm:px-5">
                <div className="mb-[40px] flex flex-col flex-wrap xs:flex-col xs:items-start xs:mb-[30px]">
                    <img
                        ...
                        src="/assets/image/footer_logo2.svg"
                        alt="logo"
                    />
                </div>

                <div className="w-full border-b border-[#C7CBD2] h-[1px] mb-7"></div>

                <div className="flex flex-col text-[16px] text-[#999CA2] text-opacity-70 lg:text-[15px] md:text-[13px] gap-[15px] font-semibold">
            ...
            <div className="w-full pb-[80px] text-[#999CA2] text-opacity-70 md:pb-[30px]">
                <div className="flex border-t border-[rgba(255,255,255,0.5)] px-[100px] md:pt-[30px] md:px-[80px] sm:px-[20px]">
